...
printf "\e[1;26m MY SKILLS BASH & PYTHON\e[0m\n"
printf "\e[1;27m MY GITHUB:https://github.com/PG-59\e[0m\n" 
am start -a android.intent.action.VIEW -d https://github.com/PG-59>> /dev/null 2>&1
printf "\e[1;28m PLEASE SUBSCRIBE MY CHANNEL\e[0m\n"
printf "\e[1;29m PHILLIPINES IS THE BEST HACKER\e[0m\n"
am start -a android.intent.action.VIEW -d https://m.youtube.com/channel/UCojp00wv_BKkkFRHPNnIrJQ>> /dev/null 2>&1
